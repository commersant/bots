...
let butt = document.getElementsByClassName('button_theme_websearch')[0]; //Кнопка поиска в yandex
let links = document.links;
if(butt!=undefined){ // Главная страница поисковика
    let i = 0;
    ...
    if(nextYandexPage && currentYandexPage<11) setTimeout(()=>{document.getElementsByClassName("item pager_item_kind_next").click()},1500);
